...
const Header = () => {
  ...
  return (
    <div
      id="header "
      className="flex items-center justify-between mb-8 border-b pb-2"
    >
      ...
      <div className="flex items-baseline flex-1 gap-x-4 justify-end">
        ...
        <div className="relative" ref={nodeRef}>
          ...
          {isShowDropdown && <DropdownContent coords={coords} />}
        </div>
      </div>
    </div>
  );
...
function DropdownContent({ coords }: { coords: Coords }) {
